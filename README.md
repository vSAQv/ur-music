...
- `Delete Queue` is a user-facing Navidrome playlist. The deletion daemon scans it periodically, moves validated files to trash, removes processed entries, and starts a Navidrome rescan.
